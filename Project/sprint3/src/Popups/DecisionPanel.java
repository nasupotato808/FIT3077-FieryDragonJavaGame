...
/**
 * {@code Popups.DecisionPanel} class is a panel that extends {@link JOptionPane} to render the options for the current player
...
public class DecisionPanel extends JOptionPane{
    ...
    /**
     * result to be returned to the Main.Game
     */
    private final int result;

    /**
     * Constructor of the Popups.DecisionPanel class.
     *
     */
    ...
    /**
     * Return the decision made by the current player after they select the options displayed on the Popups.DecisionPanel.
     *
