...
import java.awt.*;
/**
 * {@code board.BoardSetup} class extends JPanel to set up the board layout for the game.
...
public class BoardSetup extends JPanel{
    ...
    /**
     * Constructor for board.BoardSetup. Initializes the panel and sets up various components.
     */
    public BoardSetup(){
    ...
    public void setupChitCardPanel(){
        ...
        chitCardPanel.setLayout(new GridLayout(4, 4,3,3));
        chitCardPanel.setBounds(403,228,250,250);
