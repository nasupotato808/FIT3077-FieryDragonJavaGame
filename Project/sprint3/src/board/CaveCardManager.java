...
/**
 * {@code board.CaveCardManager} is a manager class to manage the CaveCard's setup.
...
public class CaveCardManager {
    ...
    /**
     * Constructor of the board.CaveCardManager class.
     *
     * @param boardSetup an instance of board.BoardSetup to configure the game board
