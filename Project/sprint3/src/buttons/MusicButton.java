...
/**
 * A {@code buttons.MusicButton} class represents a button for player to mute or on the sound.
 * It extends {@code JPanel} to render the button
 * and implements {@code MouseListener} to enable mouse interaction with {@code buttons.MusicButton},
...
public class MusicButton extends JPanel implements MouseListener {
    ...
    /**
     * Constructor of the buttons.MusicButton class.
     *
     */
    public MusicButton() {
